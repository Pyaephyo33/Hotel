        ...
        {{-- Form Head --}}
            ...
            <div class="grid grid-cols-1 gap-1">
                <div>
                    ...
                    <div class="label">
                      <span class="label-text-2xl">Role</span>
                    </div>
                    <input type="text" placeholder="Enter Role" class="input input-bordered w-full @error('name') input-error @enderror" id="name" name="name" value="{{old('name') ?? $role->name}}" />
                    @error('name')
           ...
           <div class="grid justify-items-end mt-5">
                <div class="flex space-x-2">
                    ...
                    @else
                        <a href="{{url('admin/roles')}}" class="btn btn-active btn-sm">Cancel</a>
